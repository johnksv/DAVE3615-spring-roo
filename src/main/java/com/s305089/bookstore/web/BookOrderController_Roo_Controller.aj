...
import com.s305089.bookstore.web.BookOrderController;
...
privileged aspect BookOrderController_Roo_Controller {
    ...
    public String BookOrderController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
